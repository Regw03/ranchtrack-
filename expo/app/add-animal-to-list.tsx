...
export default function AddAnimalToListScreen() {
  ...
  const { addAnimal, addAnimalToList, addHealthRecord, animals } = useRanch();
  ...
  const listTypeLabel = useMemo(() => { switch (type) { case "vaccinations": return "Vaccinations"; case "custom": return "Breeding"; case "to_be_sold": return "To Be Sold"; case "birthing": return getBirthingTitle(species); default: return ""; } }, [type, species]);
